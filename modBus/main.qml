...
//  property int fontSize25: theValue / 19
  ...
  Connections {
    target: MyGlobal
    onDoDisconnectChanged: {
      console.log("QML - do a Disconnect");
      processDisconnect();
    }
  } //Connections
  ...
  Connections {
    target: MyGlobal
    onConnectedBoolChanged: {
      console.log("QML - Connection Status Changed = ", (MyGlobal.connectedBool ? "Connected" : "Disconnected"));
      console.log("SCREENFACTOR = ", MyGlobal.screenFactor, " fontSize240 = ", fontSize240);
